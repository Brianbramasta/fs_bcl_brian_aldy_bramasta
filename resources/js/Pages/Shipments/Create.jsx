...
export default function ShipmentsCreate({ auth, fleets }) {
    ...
    return (
        <AppLayout
            user={auth.user}
            header={<h2 className="font-semibold text-xl text-gray-800 leading-tight">Book New Shipment</h2>}
        >
            <Head title="Book Shipment" />
                                    ...
                                    >
                                        ...
                                        {fleets.map((fleet) => (
                                            <option key={fleet.id} value={fleet.id}>
                                                {fleet.fleet_number} - {fleet.vehicle_type} (Available)
                                            </option>
                                        ))}
                                    </select>
